...
const EditProduct: FC = () => {
    ...
    const handleUpdate = useCallback(async () => {
        ...
        // navigate('/');
    }, [brand, category, description, handleValidate, medias, name, options, params.id, price, sku]);

    return (
        <PageContainer title="LBL_UPDATE_PRODUCT">
            ...
            <ProductFooter submitLabel="BTN_UPDATE" handleBack={() => navigate('/')} handleSubmit={handleUpdate} />

            {successModal && (
                <Modal
                    open={successModal}
                    title="LBL_SUCCESS"
                    message="LBL_PRODUCT_UPDATE_MESSAGE"
